    ...
    <div class="container">
        ...
        <section>
            ...
            <form action="index.php" method="GET">
                ...
                <input type="text" id="price" name="price" class="form-control" value="<?= $tableau->disc_price; ?>" readonly><br>

                Picture<br>
                <img src="IMG/<?= $tableau->disc_picture ?>" alt="<?= $tableau->disc_title; ?>" title="<?= $tableau->disc_title ?>" class="img-fluid"><br><br>
                
                <a href="update_form.php?disc_id=<?=$tableau->disc_id;?>&artist_id=<?= $tableau->artist_id ?>">
                    <input type="button" value="Modifier" class="btn btn-primary">
                </a>
                
                <a href="delete_form.php?disc_id=<?= $tableau->disc_id; ?>">
                    <input type="button" value="Supprimer" class="btn btn-primary">
                </a>
